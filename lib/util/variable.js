...
function getCallExpressionValue(variable) {
    return variable.defs[0].node.init.arguments[0].value;
}
...
module.exports = {
  ...
  isImportBinding: isImportBinding,
  getVariableType: getVariableType,
  getImportBindingSourceValue: getImportBindingSourceValue,
  getCallExpressionValue: getCallExpressionValue,
  getVariableLoc: getVariableLoc
};
